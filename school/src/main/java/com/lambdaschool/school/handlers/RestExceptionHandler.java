...
// all classes with @controller will come to this handler when they run into an error
@ControllerAdvice
public class RestExceptionHandler extends ResponseEntityExceptionHandler
{
    // ResponseEntityExceptionHandler already has default methods so we override them if we want to change them.
    // built into spring.
    // below is not an override this a brand new method.
